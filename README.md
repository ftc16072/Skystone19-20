## Overview
This GitHub repository contains the source code for **FTC 16072 Skystone season (2019-2020)**.
All team specific code is in [TeamCode](TeamCode/src/main/java/org/firstinspires/ftc/teamcode)

## Travis-CI build status

 Master Branch [![Build Status](https://travis-ci.com/ftc16072/Skystone19-20.svg?branch=master)](https://travis-ci.com/ftc16072/Skystone19-20)

It is based off of: https://github.com/FIRST-Tech-Challenge/SkyStone
